...
|:--------:|:---------:|
|<img src="../assets/images/personas/Decision_Maker.png" alt="Decision" title="Decision"/>|Takes appropriate decisions based on the data available on the Dashboard.Needs basic understanding of the web technology and blockchain.Basic training for the product required.
