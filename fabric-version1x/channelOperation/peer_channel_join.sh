...
docker exec $CONTAINER_NAME peer channel fetch oldest -c $CHANNEL_ID -o $ORDERER_ADDRESS --tls --cafile /etc/hyperledger/msp/users/admin/tls/tlsca.unibw.de-cert.pem
sleep 10
