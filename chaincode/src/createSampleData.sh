...
peer chaincode invoke -n mycc -c '{"Args":["createLot", "100", "123", "20", "liter", "111", "222100", ""]}' -C myc
sleep $SLEEP_TIME
#createLot (Pinzgauer 200)
peer chaincode invoke -n mycc -c '{"Args":["createLot", "200", "123", "20", "liter", "222", "222100", ""]}' -C myc
sleep $SLEEP_TIME
...
peer chaincode invoke -n mycc -c '{"Args":["createLot", "101", "123", "20", "liter", "111", "222100", ""]}' -C myc
sleep $SLEEP_TIME
#changeLot (Brangus 101 -> Pinzgauer 200)
peer chaincode invoke -n mycc -c '{"Args":["changeLot", "101", "200", "18.25"]}' -C myc
sleep $SLEEP_TIME
#createLot (Deoni 300)
peer chaincode invoke -n mycc -c '{"Args":["createLot", "300", "123", "20", "liter", "333", "222100", ""]}' -C myc
sleep $SLEEP_TIME
#createLot (Pinzgauer 201)
peer chaincode invoke -n mycc -c '{"Args":["createLot", "201", "123", "20", "liter", "222", "222100", ""]}' -C myc
sleep $SLEEP_TIME
...
sleep $SLEEP_TIME
#createLot (Deoni 350)
peer chaincode invoke -n mycc -c '{"Args":["createLot", "350", "123", "200", "liter", "333", "222100", ""]}' -C myc
sleep $SLEEP_TIME
#produceProduct (Deoni 300 350)
peer chaincode invoke -n mycc -c '{"Args":["produceProduct", "300","10", "350", "22.75"]}' -C myc
sleep $SLEEP_TIME
#createLot (Deoni 351)
peer chaincode invoke -n mycc -c '{"Args":["createLot", "351", "123", "200", "liter", "333", "222100", ""]}' -C myc
sleep $SLEEP_TIME
#produceProduct (Deoni 300 351)
peer chaincode invoke -n mycc -c '{"Args":["produceProduct", "300","10", "351", "33.75"]}' -C myc
sleep $SLEEP_TIME
#createLot (Tuxer 400)
peer chaincode invoke -n mycc -c '{"Args":["createLot", "400", "123", "20", "liter", "444", "222100", ""]}' -C myc
sleep $SLEEP_TIME
